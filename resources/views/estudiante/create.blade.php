    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-bold text-center text-gray-800 mb-8">{{ __('Registro de Estudiante') }}</h2>
                ...
                <form method="POST" action="{{ route('estudiante.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="programa" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('id_programa') border-red-500 @enderror"
