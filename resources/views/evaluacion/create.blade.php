    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-bold text-gray-800 mb-8">{{ __('Evaluar Proyecto') }}</h2>
                ...
                <div class="mb-8 bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="font-medium">{{ ucfirst($proyecto->estado) }}</p>
                        </div>
                        <div>
                ...
                <form method="POST" action="{{ route('evaluacion.store', $proyecto->id_proyecto) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input id="calificacion" type="number" step="0.1" min="0" max="5"
                            ...
                            name="calificacion" value="{{ old('calificacion') }}" required>
                        @error('calificacion')
                    ...
                    <div>
                        ...
                        <textarea id="comentarios" rows="4"
                            ...
                            name="comentarios" required>{{ old('comentarios') }}</textarea>
                        @error('comentarios')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
